<?php
include 'config.php';
$countryCode = isset($_GET['country']) ? $_GET['country'] : 'bb';
$url = 'https://wildtracks.pro/api/mountains/all/' . $countryCode . '/json/' . $TOKEN;
...
echo "<table border='1' cellpadding='5'><tr><th>Name</th><th>Type</th><th>Latitude</th><th>Longitude</th><th>Elevation</th><th>Timezone</th></tr>";
