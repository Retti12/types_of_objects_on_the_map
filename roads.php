...
$countryCode = isset($_GET['country']) ? $_GET['country'] : 'al';

$url = 'https://wildtracks.pro/api/roads/all/' . $countryCode . '/json/' . $TOKEN;
...
'PRMN' => 'promenadea place for public walking, usually along a beach front',
