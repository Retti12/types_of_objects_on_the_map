...
$countryCode = isset($_GET['country']) ? $_GET['country'] : 'cy';

$url = 'https://wildtracks.pro/api/parks/all/' . $countryCode . '/json/' . $TOKEN;
...
'BSNP' => 'petroleum basinan area underlain by an oil-rich structural basin',
