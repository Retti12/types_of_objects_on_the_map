...
$countryCode = isset($_GET['country']) ? $_GET['country'] : 'az';

$url = 'https://wildtracks.pro/api/water/all/' . $countryCode . '/json/' . $TOKEN;
...
'DOMG'   => 'vicecap dome a comparatively elevated area on an icecap',
...
'WTRH'   => 'waterhole(s)	a natural hole, hollow, or small depression that contains water, used by man and animals, especially in arid area'	
];
